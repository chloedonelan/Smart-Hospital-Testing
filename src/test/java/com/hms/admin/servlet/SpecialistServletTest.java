...
public class SpecialistServletTest {
  ...
  @InjectMocks
  private SpecialistServlet servlet;
  ...
  // Successful addition of specialist to the database
  @Test
  public void testSuccess() {
    when(request.getSession()).thenReturn(session);
    when(request.getParameter("specialistName")).thenReturn("Jane Doe");
    
    try {
      servlet.doPost(request, response);
      
      verify(session).setAttribute(eq("successMsg"), eq("Specialist added Successfully."));
